...
public:
    ...
    FMP4MediaSource(const string &vhost,
                    ...
                    int ring_size = FMP4_GOP_SIZE) : MediaSource(FMP4_SCHEMA, vhost, app, stream_id), 
    ...
    const std::string get_mse_mime_type() {
        return mse_mime_type_;
    }

    void set_mse_mime_type(std::string value) {
        mse_mime_type_ = value;
    }
