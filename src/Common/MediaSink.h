...
public:
    ...
    MediaSink(){}
    MediaSink(const std::string& stream_id) : stream_id_(stream_id) {}
    virtual ~MediaSink(){}

    void inputFrame(const Frame::Ptr &frame) override;

    bool get_inputframe_valid() {return inputframe_valid_;};
