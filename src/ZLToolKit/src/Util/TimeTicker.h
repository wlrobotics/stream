...
public:
    ...
    Ticker(uint64_t min_ms = 0,
           LogContextCapturer ctx = LogContextCapturer(Logger::Instance(), LDebug, __FILE__, "", __LINE__),
...
#if !defined(NDEBUG)
    #define TimeTicker() Ticker __ticker(5,DebugL,true)
    #define TimeTicker1(tm) Ticker __ticker1(tm,DebugL,true)
